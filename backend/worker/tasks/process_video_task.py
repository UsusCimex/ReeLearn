...
def process_video_task(self, video_id: int):
    ...
    try:
        ...
        download_success = download_file_from_s3(video.s3_url, temp_video_path)
        ...
        fragments_info = extract_subtitles(temp_video_path)
        ...
        for fragment_info in fragments_info:
            ...
            try:
                ...
                fragment_s3_url = upload_file_to_s3(file_path=fragment_path, key=fragment_filename)
